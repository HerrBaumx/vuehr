    ...
    <div>
        <div>
            ...
            <transition name="slide-fade">
                <div v-show="showAdvanceSearchView" style="border: 1px solid #409eff;border-radius: 5px;
            box-sizing: border-box;padding: 5px 0px;margin: 10px 0px">
                    ...
                    <el-row style="margin-top: 10px;margin-left: 5px">
                        <el-col :span="5">
                            ...
                            <el-popover
                                ...
                                height: 26px;border-radius: 5px;cursor: pointer;align-items: center; padding-left: 8px;box-sizing: border-box"
                        ...
                        <el-col :span="5" :offset="4">
                            ...
                            <el-button size="mini" type="primary" icon="el-icon-search">搜素</el-button>
                        </el-col>
                    </el-row>
                </div>
            </transition>
                        ...
                        <el-col :span="6">
                            <el-form-item label="姓名:" prop="name">
                                <el-input size="mini" style="width: 150px" prefix-icon="el-icon-edit"
                                          placeholder="请输入员工姓名" v-model="emp.name"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="5">
                        ...
                        <el-col :span="5">
                            <el-form-item label="籍贯:" prop="nativePlace">
                                <el-input size="mini" style="width: 120px" prefix-icon="el-icon-edit"
                                          placeholder="请输入籍贯" v-model="emp.nativePlace"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="电子邮箱:" prop="email">
                                <el-input size="mini" style="width: 150px" prefix-icon="el-icon-message"
                                          placeholder="请输入电子邮箱" v-model="emp.email"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="7">
                            <el-form-item label="联系地址:" prop="address">
                                <el-input size="mini" style="width: 200px" prefix-icon="el-icon-edit"
                                          placeholder="请输入联系地址" v-model="emp.address"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                        ...
                        <el-col :span="7">
                            <el-form-item label="电话号码:" prop="phone">
                                <el-input size="mini" style="width: 200px" prefix-icon="el-icon-phone"
                                          placeholder="电话号码" v-model="emp.phone"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col :span="6">
                            <el-form-item label="毕业院校:" prop="school">
                                <el-input size="mini" style="width: 150px" prefix-icon="el-icon-edit"
                                          placeholder="毕业院校名称" v-model="emp.school"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="7">
                            <el-form-item label="专业名称:" prop="specialty">
                                <el-input size="mini" style="width: 200px" prefix-icon="el-icon-edit"
                                          placeholder="专业名称" v-model="emp.specialty"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="身份证号码:" prop="idCard">
                                <el-input size="mini" style="width: 180px" prefix-icon="el-icon-edit"
                                          placeholder="请输入身份证号码" v-model="emp.idCard"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
